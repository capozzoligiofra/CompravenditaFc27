// Proxy locale fra l'app e Futbin.
//
// Esiste per tre motivi: il browser non può chiamare Futbin direttamente
// (CORS), le risposte vanno normalizzate in un formato stabile, e le
// chiamate vanno limitate e messe in cache. Se Futbin non risponde, ogni
// rotta ricade sul dataset demo e lo dichiara nel campo "source".
